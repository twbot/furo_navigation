...
//float lin_r,float lin_l
void FuroRobot::update()
{
    //first was negative
   ...
   // float desired_wheel_vel_r = mobile_linVel_R;
   // float desired_wheel_vel_l = mobile_linVel_L;
...
void FuroRobot::MoveFuro(float lin_r,float rot_r,float lin_l,float rot_l)
{
